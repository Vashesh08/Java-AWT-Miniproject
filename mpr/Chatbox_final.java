...
public class Chatbox_final extends Frame implements ActionListener
{
...
*/
	...
	public void actionPerformed(ActionEvent e) {
		...
		if (e.getSource()==b)
		{
			...
			if (check) {
				create_comp_label("I do not understand.");
				create_comp_label("Please type again.");
			}
